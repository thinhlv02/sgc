...
*/
$baseUrl = '/'.CKFINDER_PROJECT_PATH.'/'.CKFINDER_FOLDER_UPLOAD.'/';
...
$config['Thumbnails'] = Array(
		'url' => get_instance()->config->base_url(CKFINDER_FOLDER_UPLOAD) . '/_thumbs',
...
$config['ResourceType'][] = Array(
		'name' => 'Files',
		'url' => get_instance()->config->base_url(CKFINDER_FOLDER_UPLOAD) . '/files',
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => get_instance()->config->base_url(CKFINDER_FOLDER_UPLOAD) . '/images',
...
$config['plugin_imageresize']['largeThumb'] = '1800x1800';
