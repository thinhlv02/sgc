            ...
            <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="txtName" name="txtName" value="<?php echo $news->title?>" required="required" class="form-control col-md-7 col-xs-12" placeholder="Tiêu đề Tiếng Việt">
                        <input type="text" id="txtNameEn" name="txtNameEn" value="<?php echo $news->title_en?>" required="required" class="form-control col-md-7 col-xs-12" style="margin-top: 5px" placeholder="Tiêu đề Tiếng Anh">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        ...
                        <textarea name="txtContentEn" class="form-control" style="height: 120px"><?php echo $news->content_en?></textarea>
